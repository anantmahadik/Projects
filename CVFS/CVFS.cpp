...
void man(char *name)
{
    ...
    else if(strcmp(name,"stat")== 0)
    {
        ...
        printf("Usages : stat File\n");
    }
    else if(strcmp(name,"fsat") == 0)
    {
        printf("Description : Used to display informtion on file\n");
    ...
    {
        printf("Description : Used to close opened\n");
    ...
    else if(strcmp(name,"lseek")==0)
    {
        ...
        printf("Usages : lseek File_name ChangeInOffset StartPoint\n");
    }
    ...
    {
        printf("ERROR : No manual entry avaailable\n");
    }
}
...
void DisplayHelp()
{
    ...
    printf("fstat : To Display information of file using file descriotoe\n");
...
int GetFDFromName(char *name)
{
    ...
    void ls_file()
    {
        ...
        printf("\nFile Name\t node number\tFile size \t Link count\n");
        printf("----------------------------------------------------------\n");
        while(temp!=NULL)
        {
            if(temp->FileType!=0)
    ...
    int fstat_file(int fd)
    {
        ...
        if(temp->permission==1)
            printf("File Permisition : Read only\n");
        else if(temp->permission==2)
            printf("File Permition : Write\n");
        else if(temp->permission==3)
            printf("File Permition : Read & Write\n");
        printf("----------------------------------------------------------\n");
    ...
    int main()
    {
        ...
        while(1)//  infinite loop // unal conditional loop
        {
            fflush(stdin);
            strcpy(str,"");
            ...
            if(count==1)
            {
                ...
                else if(strcmp(command[0],"colseall")==0)
                {
                    CloseAllFile();
                    printf("All files closed successfiully\n");
                    continue;
                }
                ...
                {
                    printf("Terminating the Marvellous Virtual System\n");
                    break;
                }
                else
                {
            ...
            else if(count == 2)
            {
                if(strcmp(command[0],"stat")==0)
                {
                    ...
                    if(ret==-1)
                        printf("ERROR: Incorrdct parameters\n");
                    if(ret==-2)
            ...
            else if(count == 3)
            {
                if(strcmp(command[0],"create")==0)
                {
                    ...
                    if(ret>=0)
                        printf("File is successfully created with file decscriptor : %d\n",ret);
                    if(ret==-1)
